...
export default function Header() {
    ...
    const [scrollDelta, setScrollDelta] = useState(typeof window !== 'undefined'? window.scrollY : 'undefined');
    ...
    return (
        <header className={styles.header}>
            ...
            >
                <Link className={styles.linkSmallScreen} href="/">Home</Link>
                <Link className={styles.linkSmallScreen} href="/about">About</Link>
                <Link className={styles.linkSmallScreen} href="/contact">Contact</Link>
                ...
                <button onClick={handleClick}>
                    {scrollDelta > 200? <RiCloseCircleFill className={styles.closeCircle} /> : ""}
                </button>
            </div>
            <button onClick={handleClick} className={styles.menu}>
                {!showMenu? <RiMenuFill className={styles.menuSize} /> : <RiCloseFill className={styles.menuSize} />}
            </button>
            <div
                style=
                {{ 
            ...
            <div className={styles.socials}>
                ...
                <Link className={styles.social} href="/"><RiYoutubeFill className={styles.socialIcon} /></Link>
            </div>
        </header>
    );
};